export const en = {
  nav: {
    ...
    maintenanceCta: "Pool maintenance →",
  },
  ...
  common: {
    ...
    ctaText: "Get a personalised estimate within 48h.",
    before: "Before",
    after: "After",
    progress: "Progress",
    call: "Call",
  ...
  about: {
    heroLabel: "MN3J-GROUP team on site",
    eyebrowCompany: "Our company",
    title: "About MN3J-GROUP",
    subtitle: "A passionate team, a constant standard.",
    // editoEyebrow: "Editorial",
    ...
    teamPlaceholderName: "To be added",
    roles: {
      ceo: "Managing Director & Technical Director",
      training: "Head of Aquatic Training",
      btp: "Construction Site Manager",
      decoration: "Head of Decoration",
    },
    bios: {
      ceo: "With recognised expertise in managing complex projects, building aquatic structures and installation safety, MOTCHOA Séraphin leads MN3J-GROUP with a focus on technical compliance and precise execution. He oversees the strategic direction and quality control of every site.",
    },
  ...
  projectsPage: {
    heroLabel: "Aerial view of an MN3J-GROUP project",
    eyebrow: "Our work",
    title: "Our projects",
  ...
  data: {
    ...
    category: {
      "Piscine à débordement miroir": "Mirror infinity pool",
    ...
    stats: {
      "Chantiers réalisés": "Projects completed",
      "Ans d'expérience": "Years of experience",
      "Nageurs formés": "Swimmers trained",
      "Clients satisfaits": "Satisfied clients",
    },
    services: {
      piscines: {
        title: "High-end pools",
        tagline: "Pools",
      ...
      entretien: {
        ...
        accent: "Care",
        description:
          "A high-end pool is preserved through rigorous maintenance: water balance, filtration and regular checks for healthy water all year round.",
        subItems: [
          { title: "Water treatment & balance", description: "pH control, disinfection and algae prevention." },
          { title: "Cleaning & filtration", description: "Upkeep of the pool, filters and circulation equipment." },
          { title: "Seasonal checks", description: "Winterising, start-up and periodic diagnostics." },
          { title: "Bespoke maintenance contracts", description: "Plans tailored for residences, hotels and sports complexes." },
        ],
      },
    },
    projects: {
