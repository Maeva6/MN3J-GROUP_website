export const fr = {
  nav: {
    ...
    maintenanceCta: "Entretien de piscine →",
  },
  ...
  common: {
    ...
    ctaText: "Recevez une estimation personnalisée sous 48h.",
    before: "Avant",
    after: "Après",
    progress: "Avancement",
    call: "Appeler",
  ...
  about: {
    heroLabel: "Équipe MN3J-GROUP sur chantier",
  ...
  projectsPage: {
    heroLabel: "Vue aérienne d'un chantier MN3J-GROUP",
  ...
  projectDetail: {
    ...
    backToProjects: "← Retour aux chantiers",
  ...
  data: {
    ...
    category: {
      "Piscine à débordement miroir": "Piscine à débordement miroir",
    ...
    stats: {
      "Chantiers réalisés": "Chantiers réalisés",
      "Ans d'expérience": "Ans d'expérience",
      "Nageurs formés": "Nageurs formés",
      "Clients satisfaits": "Clients satisfaits",
    },
    services: {
      piscines: {
        title: "Piscines haut de gamme",
        tagline: "Piscines",
      ...
      entretien: {
        ...
        accent: "Care",
        description:
          "Une piscine haut de gamme se préserve par un entretien rigoureux : équilibre de l'eau, filtration et contrôles réguliers pour une eau saine toute l'année.",
        subItems: [
